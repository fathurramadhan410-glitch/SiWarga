...
export default function RiwayatPengajuan() {
  ...
  const handleCetakUlang = async (surat: any) => {
    // Ambil data warga berdasarkan NIK di riwayat pengajuan
  ...
  return (
    <div>
      ...
      {/* MODAL PREVIEW & CETAK SURAT */}
      {printData && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex flex-col items-center justify-center p-4 no-print">
          <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white p-4 border-b flex justify-between items-center z-10 no-print">
            ...
            <div className="p-4">
              {/* Komponen Surat A4 yang akan dicetak */}
              <div id="print-area">
                <SuratFormat 
            ...
            <div className="sticky bottom-0 bg-white p-4 border-t flex justify-end gap-3 no-print">
