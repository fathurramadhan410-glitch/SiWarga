...
export default function SuratFormat({ jenis, data, keperluan, nomorSurat }: SuratProps) {
  ...
  const gayaSurat: React.CSSProperties = {
    ...
    color: "#000",
    width: "210mm",
    height: "297mm", // Diubah menjadi height agar pas 1 halaman
    padding: "20mm 25mm", // Margin atas-bawah 20mm, kiri-kanan 25mm
  ...
  const renderIsiSurat = () => {
    switch (jenis) {
      case "Surat Keterangan Tidak Mampu":
        return <p>Berdasarkan pengetahuan yang sebenarnya, keterangan saksi-saksi, serta pengamatan langsung di lapangan, orang tersebut di atas benar-benar merupakan warga miskin yang kurang mampu secara ekonomi. Keadaan ekonominya diperkirakan tidak sanggup lagi untuk membayar biaya {keperluan}. Surat keterangan ini dibuat untuk dipergunakan sebagai kelengkapan administrasi dalam mengurus {keperluan} di instansi terkait.</p>;
      case "Surat Keterangan Domisili":
        return <p>Berdasarkan data yang ada pada kami, orang tersebut di atas benar-benar berdomisili dan bertempat tinggal tetap di alamat tersebut di atas. Yang bersangkutan dinyatakan sebagai penduduk yang menetap di wilayah RT {RT_CONFIG.rt} / RW {RT_CONFIG.rw} Kelurahan {RT_CONFIG.kelurahan}. Surat keterangan ini dibuat untuk keperluan {keperluan}.</p>;
      case "Surat Pengantar KTP/KK":
        return <p>Orang tersebut di atas belum memiliki / membutuhkan perpanjangan dokumen Kartu Tanda Penduduk (KTP) atau Kartu Keluarga (KK). Surat pengantar ini dibuat untuk dipergunakan sebagai syarat administrasi mengurus pembuatan atau perpanjangan dokumen kependudukan di Dinas Kependudukan dan Pencatatan Sipil (Disdukcapil) {RT_CONFIG.kota}.</p>;
      case "Surat Pengantar Nikah":
        return <p>Orang tersebut di atas berstatus {data.statusPerkawinan || "Belum Kawin"} dan akan mengurus persyaratan pencatatan nikah. Berdasarkan catatan kami, tidak ada halangan hukum maupun syariat bagi yang bersangkutan untuk melangsungkan pernikahan. Surat pengantar ini dibuat untuk keperluan {keperluan} di Kementerian Agama (KUA) Kecamatan {RT_CONFIG.kecamatan}.</p>;
      case "Surat Pengantar SKCK":
        return <p>Orang tersebut di atas bersedia dan mengajukan permohonan pembuatan Surat Keterangan Catatan Kepolisian (SKCK). Berdasarkan catatan kami selama yang bersangkutan berdomisili di wilayah kami, yang bersangkutan berkelakuan baik, taat hukum, dan tidak pernah tersangkut perkara pidana. Surat ini dibuat untuk keperluan {keperluan} di Kepolisian Resor (Polres) setempat.</p>;
      case "Surat Keterangan Usaha":
        return <p>Orang tersebut di atas benar-benar memiliki dan menjalankan usaha di bidang {keperluan}. Usaha tersebut berlokasi di alamat yang tersebut di atas dan telah berjalan secara aktif. Surat keterangan ini dibuat untuk dipergunakan sebagai kelengkapan administrasi perizinan usaha atau pengajuan permodalan/kredit usaha di bank/lembaga terkait.</p>;
      case "Surat Keterangan Kematian/Kelahiran":
        return <p>Keterangan ini dibuat berdasarkan keterangan saksi-saksi dan bukti di lapangan bahwa hal tersebut terkait dengan peristiwa {keperluan}. Surat ini dibuat agar yang bersangkutan dapat melapor dan mengurus dokumen kependudukan terkait peristiwa {keperluan} di Disdukcapil {RT_CONFIG.kota}.</p>;
      case "Surat Rekomendasi":
        return <p>Berdasarkan pengamatan, rekam jejak, dan pengetahuan kami selama yang bersangkutan berdomisili di wilayah kami, orang tersebut di atas adalah warga yang aktif, berkelakuan baik, dan layak untuk mendapatkan rekomendasi terkait {keperluan}. Surat rekomendasi ini dibuat atas permintaan yang bersangkutan untuk dipergunakan sebagaimana mestinya.</p>;
      default:
